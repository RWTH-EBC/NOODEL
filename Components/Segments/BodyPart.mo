...
partial model BodyPart "Template of any body part"
  ...
  outer Modelica.SIunits.HeatFlowRate Qb;
  ...
  outer Modelica.SIunits.HeatFlowRate Qshiv;
  outer Modelica.SIunits.HeatFlowRate Qmet;
  outer NOODEL.NonSIUnits.MetabolicRate met;
  outer Modelica.SIunits.Area Stotal;
