...
class Skin
  ...
  parameter Modelica.SIunits.SpecificHeatCapacity Cskin "Heat capacity of compartment,
...
equation
  ...
  Cskin*weight*der(twoThermCompartment.therm1.T)=Q+twoThermCompartment.therm1.Q_dot+twoThermCompartment.therm2.Q_dot-E-QMT+Qs-Qcon-Qrad;
  if Icl > 0 then
