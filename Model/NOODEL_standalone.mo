...
model NOODEL_standalone "NOODEL as standalone model"
  ...
  Modelica.SIunits.Area   Stotal = head.skin.S+back.skin.S+chest.skin.S
  ...
  // Heat flows
  inner NOODEL.NonSIUnits.MetabolicRate Qshiv "Heat production by shivering";
  inner NOODEL.NonSIUnits.MetabolicRate Qmet;
  inner Modelica.SIunits.HeatFlowRate met "Metabolic rate of whole body";
  ...
  Modelica.Blocks.Sources.CombiTimeTable InputData(
    ...
    columns=2:134,
    fileName=
        "D:/Komfortmodell/2018/Veroeffentlichung/NOODEL/DataBase/BC_Gagge_28-48-28_degree.txt")
...
equation
  ...
  for k in 1:16 loop
   ...
   connect(InputData.y[131], parameters.T0sk);
   connect(InputData.y[132], parameters.T0cr);
   connect(InputData.y[133], parameters.Position);
 ...
 larm, rhand, lhand, rthigh, lthigh, rleg, lleg, rfoot, lfoot",
    ...
    experiment(StopTime=13500, Interval=60),
